...
namespace PointTest2_KinectRegion
{
    ...
    sealed partial class App : Application
    {
        ...
        public KinectCoreWindow kinectCore;
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
           ...
           // KinectSensor.GetDefault().Open();
            ...
            KinectUserViewer kinectViewer = new KinectUserViewer() { Width=150, Height=130 , VerticalAlignment = VerticalAlignment.Top, HorizontalAlignment = HorizontalAlignment.Right};
